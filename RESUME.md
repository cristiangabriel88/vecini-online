...
- date: 2026-06-06
- last_task: T268 Onboarding progress indicator -- extracted clampStep/nextCarouselStep/prevCarouselStep/isLastCarouselStep to welcomeLogic.ts; added visible 1/3 step counter in carousel footer; skip button more prominent (border + weight); stepCounter i18n key in both locales; 14 unit tests; all 3 builds green
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 313 test files / 3055 tests
...
- next: T269 [P3] Empty-state consistency audit
