...
- date: 2026-06-06
- last_task: T267 Unsaved-changes guard -- useUnsavedGuard hook (useBlocker + beforeunload + bypassRef), UnsavedChangesModal, adopted in ApartmentFormPage, bilingual keys, 16 unit tests, 3 E2E; all 3 builds green
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 312 test files / 3045 tests
...
- next: T268 [P3] Onboarding progress indicator
