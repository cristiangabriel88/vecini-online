...
- date: 2026-06-05
- last_task: T249 Asociație detail page + lifecycle (suspend/reactivate/archive) -- detail route, migration, Netlify function, audit actions, demo status, store v5, filter tabs, unit + E2E tests
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 289 test files / 2755 tests
...
- next: T250 [P1] Pending-invite resend / revoke + per-tenant admin roster
