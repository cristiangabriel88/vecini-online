...
- date: 2026-06-06
- last_task: T270 Sync html lang to active locale -- `languageChanged` listener in i18n.ts updates `document.documentElement.lang` on init + every `changeLanguage()` call; 3 unit tests; all 314 test files / 3058 tests green; all 3 builds pass
...
- next: T271 [P2] Automated a11y scan in E2E + fixes
