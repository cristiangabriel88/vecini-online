...
- date: 2026-06-06
- last_task: T265a Shared Photo component -- new src/shared/components/Photo.tsx (lazy/async img, null/error fallback); migrated ProfilePage + WelcomeProfile avatar ternaries to <Photo>; 8 unit tests; all 3 builds green
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 309 test files / 2995 tests
...
- next: T265b [P2] Client-side image downscale before upload
