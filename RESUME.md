...
- date: 2026-06-04
- last_task: T223 [P2] E2E for F06 Locator + F66 Profile + F67 Home customization
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 260 files / 2394 tests
- stages: PROD/DEV/DEMO formalized (T171/T172); all three build green every task
- mvp_spine: complete (T168/T169/T92/T55/T115 done; T128 token hardening done)
- next: T224 [P2] Scheduled-announcement server-side hold-back (RLS expression on published_at/scheduled_at)
