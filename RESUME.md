...
- date: 2026-06-06
- last_task: T257 User-facing perf/reduce-motion mode -- perfStore.ts (Zustand, resolvePerf() pure helper); URL param + user pref + prefers-reduced-motion + stage default; Auto/Lite/Full toggle in UserMenu; bilingual; 11 unit tests
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 301 test files / 2890 tests
...
- next: T258a [P1] Durable error persistence + release/stage tagging
