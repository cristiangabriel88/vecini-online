...
- date: 2026-06-06
- last_task: T266 Consolidate hand-rolled form validation + drop unused dep -- new src/shared/lib/useFormState.ts hook; migrated ApartmentFormPage + BuildingSettingsPage; removed react-hook-form + @hookform/resolvers; 11 unit tests; all 3 builds green
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 311 test files / 3029 tests
...
- next: T267 [P2] Unsaved-changes guard
