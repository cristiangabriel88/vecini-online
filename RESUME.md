...
- date: 2026-06-05
- last_task: T235 [P2] Visible-first intent router with structured schema + pluggable phrasing engine
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 284 test files / 2722 tests
- stages: PROD/DEV/DEMO formalized (T171/T172); all three build green every task
- mvp_spine: complete (T168/T169/T92/T55/T115 done; T128 token hardening done)
- next: T236 [P2] Wire visible-first grounding into the assistant widget
