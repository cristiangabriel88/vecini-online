...
- date: 2026-06-03
- last_task: T203 (P2) E2E happy path for F01 Anunțuri -- 3 paths (immediate publish + category badge + unread indicator; scheduled badge visible to manager + hidden from resident; file attachment + download button); 6/6 passes on chromium + mobile
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 210 files / 2101 tests
- stages: PROD/DEV/DEMO formalized (T171/T172); all three build green every task
- mvp_spine: complete (T168/T169/T92/T55/T115 done; T128 token hardening done)
- next: T204 In-app notification fan-out for ticket.status_changed and discussion.reply [P2]
