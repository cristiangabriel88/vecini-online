...
- date: 2026-06-05
- last_task: T234 [P2] Visible-state adapter for the assistant (DOM grounding foundation)
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 284 test files / 2703 tests
- stages: PROD/DEV/DEMO formalized (T171/T172); all three build green every task
- mvp_spine: complete (T168/T169/T92/T55/T115 done; T128 token hardening done)
- next: T235 [P2] Visible-first intent router with structured schema + pluggable phrasing engine
