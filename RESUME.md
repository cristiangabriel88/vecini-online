...
- date: 2026-06-06
- last_task: T265b Client-side image downscale before upload -- new src/shared/lib/imageResize.ts (isResizableImage, calcResizeDimensions, downscalePhoto); wired in ticketsApi + announcementsApi live paths + TicketsPage + AnnouncementsPage demo paths; 23 unit tests; all 3 builds green
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 310 test files / 3018 tests
...
- next: T266 [P2] Consolidate hand-rolled form validation + drop unused dep
