...
- date: 2026-06-06
- last_task: T258a Durable error persistence + release/stage tagging -- errorOutbox.ts (localStorage, max 20, flush-on-init, retry on next session); ErrorReport.release/stage; vite.config define from git SHA; DB migration + Netlify function; platform errors page shows build/stage per group; 15 unit tests
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 302 test files / 2904 tests
...
- next: T258b [P2] Source-map symbolication for error stacks
