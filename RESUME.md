...
- date: 2026-06-05
- last_task: T255 Cross-tenant global search -- platformSearchLogic.ts (pure search/rank helper, scoreMatch reuse, 6-cap per kind), PlatformCommandPalette.tsx (portal overlay, keyboard nav, two groups: asociatii/admins), search trigger in platform topbar, .platform-search-trigger CSS, platform.search.* i18n RO/EN, 16 unit tests
- pipeline: green (lint + typecheck + test + build + build:pi + build:demo)
- counts: 294 test files / 2827 tests
...
- next: T256 [P3] Per-tenant feature-flag overrides
