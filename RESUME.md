...
- date: 2026-06-06
- last_task: T259 Test-coverage tooling + threshold gate -- @vitest/coverage-v8; test:coverage script; vite.config.ts coverage block (provider v8, reporters text-summary/html/json-summary, include src/**, excludes demo/d.ts/main, thresholds lines:30 branches:80 functions:68 statements:30); CI runs test:coverage + uploads HTML artifact (30d)
- pipeline: green (lint + typecheck + test:coverage + build + build:pi + build:demo)
...
- next: T260 [P2] Bundle-size budget + analyzer
