...
/**
 * T06 — GDPR data-subject rights. The export, erasure plan, retention policy
 * and request model are pure and backend-free, so the whole right is exercised
 * here without a backend (it runs offline in CI / demo mode).
 */
